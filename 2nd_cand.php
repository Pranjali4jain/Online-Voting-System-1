...
<title>GLA UNIVERSITY 2nd_Candiate</title>
...
<div class="container">
         ...
         <div class="row">
           ...
           <p class="text-center" style="margin-bottom: 50px;">Second Year Candidates</p>
         </div>
         <?php 
        ...
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-left:25px; padding-top: 30px;">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" src="./img/candidate.png" alt="shinzo" height="350px">
                  <div class="card-body">
            ...
            <div class="col-md-6">
              ...
              <div class="Footer">
                <ul style="display: flex;">
                  <li style="list-style: none; padding: 10px; "><a href="index.html" style="text-decoration: none; color: #b6784f;">Home</a></li>
                  <li style="list-style: none; padding: 10px; "><a href="about.php" style="text-decoration: none; color: #b6784f;">About</a></li>
                  <li style="list-style: none; padding: 10px; "><a href="suggestion.html" style="text-decoration: none; color: #b6784f;">Suggestion</a></li>
                  <li style="list-style: none; padding: 10px; "><a href="contact_form.php" style="text-decoration: none; color: #b6784f;">Contact</a></li>
                </ul>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <ul >
                <li>
                    <a href="https://www.facebook.com/glauniv/" target="_blank">
                ...
                <li>
                    <a href="https://www.linkedin.com/school/gla-university/" target="_blank">
                        <i class="fa fa-linkedin"></i>
                    </a>
                </li>
                <li>
                    <a href="https://twitter.com/gla_mathura/" target="_blank">
